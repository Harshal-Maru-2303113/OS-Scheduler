...
from algorithms.hpf_with_aging import hpf_with_aging
...
class Scheduler:
    ...
    def lottery(self, quantum=1, context_switch=0):
        return lottery(self.processes, quantum, context_switch)
    
    def hpf_with_aging(self, context_switch=0, aging_interval=5, aging_increment=1):
        return hpf_with_aging(self.processes, context_switch, aging_interval, aging_increment)
