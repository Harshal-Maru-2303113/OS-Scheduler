...
class SchedulerApp:
    def __init__(self, master):
        self.master = master
        master.title("OS Scheduler Visualizer")
        ...
        self.aging_interval_var = self.controls_frame.aging_interval_var
        self.aging_increment_var = self.controls_frame.aging_increment_var
